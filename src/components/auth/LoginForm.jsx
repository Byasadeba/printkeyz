// LoginForm.jsx - Updated with Direct Hex Colors
'use client';
          ...
          <form onSubmit={submit} className="relative z-10 space-y-6">
            ...
            <div className="text-center space-y-3 pt-4 pb-8">
              ...
              <p className="text-sm sm:text-base text-[#7B5E57] max-w-xs mx-auto leading-relaxed">
                Access your PrintKeyz dashboard instantly
              </p>
            </div>
            ...
            <div className="text-center space-y-4 pt-6 pb-4">
              <Link
                href="/auth/forgot"
                className="group block w-full py-3 px-6 rounded-xl font-semibold text-base bg-gradient-to-r from-transparent via-[#E6D3B1]/30 to-transparent
                           text-[#3E2723] hover:text-[#7F5539] hover:bg-[#E6D3B1]/50
                           border border-[#E6D3B1]/50 hover:border-[#B08968]/60 hover:shadow-md
